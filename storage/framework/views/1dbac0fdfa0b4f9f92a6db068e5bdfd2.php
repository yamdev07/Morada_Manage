...
<?php $__env->startSection('title', 'Dashboard - Rooms Occupancy'); ?>
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            ...
                            Occupied rooms on <?php echo e(Helper::dateFormat($date)); ?>

                        </p>
                    </div>
                    <div class="d-flex align-items-center gap-3">
                        <div class="badge bg-primary fs-6 px-3 py-2">
                            <?php echo e($transactions->count()); ?> <?php echo e(Str::plural('Room', $transactions->count())); ?> Occupied
                        </div>
                        ...
                        <div class="card border-0 shadow-sm h-100 hover-lift">
                            ...
                            <div class="card-header bg-white border-0 pb-0 pt-4 px-4">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div>
                                        <span class="badge <?php echo e($isCheckingOutToday ? 'bg-warning' : 'bg-primary'); ?> px-3 py-2 fs-6">
                                            <i class="fas fa-door-closed me-2"></i>
                                            Room <?php echo e($transaction->room->number); ?>

                                        </span>
                                    </div>
                                    <div class="text-end">
                                        <div class="text-muted small">Status</div>
                                        <div class="fw-bold <?php echo e($transaction->room->roomStatus->color_class ?? 'text-primary'); ?>">
                                            <?php echo e($transaction->room->roomStatus->name ?? 'Occupied'); ?>
                            ...
                            <div class="card-body px-4 pt-0">
                                <div class="d-flex align-items-center mb-4">
                                    <div class="avatar avatar-lg me-3">
                                        <img src="<?php echo e($transaction->customer->user->getAvatar() ?? 'https://ui-avatars.com/api/?name=' . urlencode($transaction->customer->name) . '&background=random'); ?>"
                                             class="rounded-circle border" 
                                             alt="<?php echo e($transaction->customer->name); ?>">
                                    </div>
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="text-muted small">
                                            ...
                                            <?php echo e($transaction->customer->phone ?? 'No phone'); ?>
                                        ...
                                        <div class="col-6">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="fw-bold"><?php echo e(Helper::dateFormat($transaction->check_in)); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="fw-bold"><?php echo e(Helper::dateFormat($transaction->check_out)); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-6">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="fw-bold <?php echo e($daysLeft <= 1 ? 'text-danger' : 'text-dark'); ?>">
                                                        <?php echo e($daysLeft); ?> <?php echo e(Str::plural('Night', $daysLeft)); ?>
                                        ...
                                        <div class="col-6">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="fw-bold <?php echo e($balance > 0 ? 'text-danger' : 'text-success'); ?>">
                                                        <?php echo e(Helper::convertToRupiah($balance)); ?>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="fw-medium"><?php echo e($transaction->room->type->name ?? 'Standard Room'); ?></span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="d-grid gap-2">
                                    ...
                                    <div class="btn-group w-100">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item" href="<?php echo e(route('transaction.edit', ['transaction' => $transaction->id])); ?>">
                                                    <i class="fas fa-edit me-2"></i> Edit Stay
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="#" onclick="roomMove(<?php echo e($transaction->id); ?>)">
                                            ...
                                            <li>
                                                <a class="dropdown-item text-danger" href="#" 
                                                   onclick="confirmCheckout(<?php echo e($transaction->id); ?>)">
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body py-5 text-center">
                            ...
                            <p class="text-muted mb-4">
                                There are no occupied rooms on <?php echo e(Helper::dateFormat($date)); ?>.
                                <br>
                            ...
                            <div class="d-flex justify-content-center gap-3">
                                ...
                                <a href="<?php echo e(route('room.index')); ?>" class="btn btn-outline-primary">
                            ...
                            <div class="row g-4">
                                <div class="col-md-3">
                                    <div class="text-center p-3 bg-blue-soft rounded-3">
                                        <div class="display-6 fw-bold text-primary"><?php echo e($transactions->count()); ?></div>
                                ...
                                <div class="col-md-3">
                                    <div class="text-center p-3 bg-warning-soft rounded-3">
                                        ...
                                        ?>
                                        <div class="display-6 fw-bold text-warning"><?php echo e($checkingOutToday); ?></div>
                                ...
                                <div class="col-md-3">
                                    <div class="text-center p-3 bg-danger-soft rounded-3">
                                        ...
                                        ?>
                                        <div class="display-6 fw-bold text-danger"><?php echo e($pendingPayments); ?></div>
                                ...
                                <div class="col-md-3">
                                    <div class="text-center p-3 bg-success-soft rounded-3">
                                        ...
                                        ?>
                                        <div class="display-6 fw-bold text-success"><?php echo e($completedPayments); ?></div>
...
<?php echo $__env->make('template.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP ELITEBOOK\Desktop\dev\HotelManagement\resources\views\dashboard\chart_detail.blade.php ENDPATH**/ ?>