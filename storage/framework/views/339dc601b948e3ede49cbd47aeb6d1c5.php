    ...
    <div class="auth-container">
        ...
        <div class="auth-card">
            <div class="auth-card-body">
                ...
                <!-- Confirmation Form -->
                <form method="POST" action="<?php echo e(route('password.confirm')); ?>" class="auth-form" id="confirmForm">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="auth-actions">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="btn btn-outline-light auth-secondary-btn">
                    ...
                    <div class="auth-links">
                        <a href="<?php echo e(url()->previous()); ?>" class="auth-link">
...
<?php echo $__env->make('template.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP ELITEBOOK\Desktop\dev\HotelManagement\resources\views\auth\passwords\confirm.blade.php ENDPATH**/ ?>