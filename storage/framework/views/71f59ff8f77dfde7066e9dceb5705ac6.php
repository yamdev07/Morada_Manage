            ...
            <div class="ms-auto d-flex align-items-center">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg" aria-labelledby="dropdownMenuButton2" style="width: 320px;">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = auth()->user()->unreadNotifications->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <li>
                                    <a class="dropdown-item py-3 border-bottom"
                                       href="<?php echo e(route('notification.routeTo', ['id' => $notification->id])); ?>">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <p class="mb-1 fw-medium"><?php echo e($notification->data['message'] ?? 'New notification'); ?></p>
                        ...
                        <?php if(auth()->user()->unreadNotifications->count() > 0): ?>
                            ...
                            <li class="d-flex justify-content-between px-3 py-2">
                                <a href="<?php echo e(route('notification.markAllAsRead')); ?>" class="btn btn-sm btn-outline-primary">
                                    Mark all read
                                </a>
                                <a href="<?php echo e(route('notification.index')); ?>" class="btn btn-sm btn-primary">
                                    View All
                                </a>
                            </li>
                        <?php endif; ?>
                ...
                <div class="dropdown">
                    <div class="dropdown-toggle d-flex align-items-center" id="dropdownMenuButton1"
                        ...
                        <img src="<?php echo e(auth()->user()->getAvatar()); ?>"
                             class="rounded-circle me-2"
                             width="32" height="32" alt="Profile">
                        <div class="d-none d-md-block text-start">
                            <div class="fw-medium" style="font-size: 0.875rem;"><?php echo e(auth()->user()->name); ?></div>
                            <div class="text-muted" style="font-size: 0.75rem;"><?php echo e(auth()->user()->role); ?></div>
                        </div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center"
                               href="<?php echo e(route('user.show', ['user' => auth()->user()->id])); ?>">
...
<?php /**PATH C:\Users\HP ELITEBOOK\Desktop\dev\HotelManagement\resources\views\template\include\_navbar.blade.php ENDPATH**/ ?>