        ...
        <div class="auth-card">
            <div class="auth-card-body">
                ...
                <div class="auth-actions">
                    <form method="POST" action="<?php echo e(route('verification.resend')); ?>" class="d-inline w-100" id="resendForm">
                        <?php echo csrf_field(); ?>
                    ...
                    <a href="<?php echo e(route('logout')); ?>" class="btn btn-outline-light auth-secondary-btn"
...
<?php echo $__env->make('template.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP ELITEBOOK\Desktop\dev\HotelManagement\resources\views\auth\verify.blade.php ENDPATH**/ ?>